...
$mail->Username = "pruebaswebufps@gmail.com";
$mail->Password = "kakaroto1494";
$mail->setFrom('palo1493@gmail.com', 'Invitacion de union a proyecto - Feria proyectos aula');
$mail->addAddress($email);
$mail->isHTML(true);
...
$mail->SMTPOptions = array('ssl' => array('verify_peer' => false, 'verify_peer_name' => false, 'allow_self_signed' => true));
    ...
    function retornarPlantillaInvitacionProyecto($keyValidacion,$nombreProyecto,$idProyecto){
        $algo= "'Roboto'";
    $url= 'http://localhost/Proyectosdeaula/unirse='.$idProyecto.'-'.$keyValidacion;
...
<!--[if mso]></td></tr></table><![endif]-->
  ...
  <!--[if (IE)]></div><![endif]-->
    ...
    $algo= "'Roboto'";
    $url= 'http://localhost/Proyectosdeaula/Validacion='.$key;
    $plantilla= '<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
    <!--[if gte mso 9]><xml>
     <o:OfficeDocumentSettings>
      <o:AllowPNG/>
